 ...
 <header class="main-header header-style-five">
             ...
             <div class="inner clearfix">
                 ...
                 <div class="logo-box">
                     <div class="logo"><a href="{{ route('home') }}"
                             title=""><img
                                 src="{{ asset('assets/images/logo-two.png') }}"
                                 alt=""
                                 title=""></a></div>
                 </div>
     ...
     <div class="mobile-menu">
         ...
         <nav class="menu-box">
             <div class="nav-logo"><a href="{{ route('home') }}"><img src="{{ asset('assets/images/logo-two.png') }}" alt=""
                         title=""></a></div>
 ...
 <section class="hidden-bar right-align">
     ...
     <div class="hidden-bar-wrapper">
         ...
         <div class="logo">
             <a href="{{ route('home') }}"><img src="{{ asset('assets/images/logo-two.png') }}" alt="" width="180px" /></a>
         </div>
