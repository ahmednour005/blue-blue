        ...
        <div class="banner-inner">
            ...
            <div class="auto-container">
                <div class="inner-container clearfix">
                    <h1>@lang('site.print_services')</h1>
                    <div class="page-nav">
                        <ul class="bread-crumb clearfix">
                            <li><a href="{{ route('home') }}">@lang('site.Home')</a></li>
                            <li><a href="{{ route('print.index') }}">@lang('site.Print')</a></li>
                            <li class="active">@lang('site.print_services')</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="team-section">
        ...
        <div class="auto-container">
            <div class="sec-title centered mb-4">
                ...
                <h2>@lang('site.all_print_services')</h2>
            </div>
            <hr>
                                        ...
                                        <figure class="image">
                                            @if ($pr->imageCategoryPrints()->exists())
                                                <a class="lightbox-image" href="{{ asset('uploads/' . $pr->image) }}"><img
                                                        src="{{ asset('uploads/' . $pr->imageCategoryPrints[0]->image) }}"
                                                        alt=""></a>
                                            @endif
                                        </figure>
                                        <div class="hover-box">
