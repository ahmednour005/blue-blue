                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger deleteExpense" data-userid="{{$category->id}}"><i class="mdi mdi-delete"></i></button> 
                                     <a type="button" href="{{ route('category-print.edit',$category->id) }}" class="btn btn-success waves-effect waves-light " ><i class="mdi mdi-pencil-outline"></i></a>
                                </td>
                            </tr>
                            @endforeach
...
<div id="applicantDeleteModal" class="modal modal-danger fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
            <form action="{{route('category.print.delete')}}" method="POST" class="remove-record-model">
                @csrf
                @method('delete')
