...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{route('category-print.store')}}"  enctype="multipart/form-data">
                        @csrf

                        <h5 class="my-4 text-uppercase "><i class="mdi mdi-account-circle me-1"></i>   اضافة تصنيف</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select  name="parent_id" class="form-control @error('parent_id') is-invalid @enderror" id="parent_id"
                                         ...
                                         @foreach($category_prints as $category_print)
                                         <option {{option_select($category_print->id,old('parent_id'))}} value="{{$category_print->id}}">{{$category_print->title_ar}}</option>
                                         @endforeach
                                    </select>
                                    @error('parent_id')
                                    <p class="text-danger">{{ $message }}</p>
                                    ...
                                    @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="radio mb-1">
                                                    <input type="radio" name="design" id="genderM" value="1"  required="">
                                                    <label for="genderM">نعم</label>
                                                </div>
                                                <div class="radio">
                                                    <input type="radio" name="design" id="genderF" value="0">
