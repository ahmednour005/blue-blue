...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"> تعديل لغة </h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{route('category-translation.update',$category_translation->id)}}"
                        enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <h5 class="my-4 text-uppercase "><i class="mdi mdi-account-circle me-1"></i> تعديل لغة</h5>
                        <div class="row">
                            <div class="col-md-3">
                                <img src="{{asset('uploads/'.$category_translation->image)}}" alt="image"
                                    class="img-fluid avatar-lg rounded">
                                <p>
                                    <span>صورة اللغة</span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{old('title_ar',$category_translation->title_ar)}}"
                                        name="title_ar" class="form-control @error('title_ar') is-invalid @enderror"
                                        id="title_ar" value="{{old('title_ar')}}" required>
                                    @error('title_ar')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{old('title_en',$category_translation->title_en)}}"
                                        name="title_en" class="form-control @error('title_en') is-invalid @enderror"
                                        id="title_en" value="old('title_en')" required>
                                    @error('title_en')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" step="0.01"
                                        value="{{old('price',$category_translation->price)}}" name="price"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="subtitle_ar"
                                        value="{{old('subtitle_ar',$category_translation->subtitle_ar)}}"
                                        class="form-control @error('subtitle_ar') is-invalid @enderror" id="subtitle_ar"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="subtitle_en"
                                        value="{{old('subtitle_en',$category_translation->subtitle_en)}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="describe_ar"
                                        class="form-control @error('describe_ar') is-invalid @enderror" id="describe_ar"
                                        value="" required>
                                        {{old('describe_ar',$category_translation->describe_ar)}}
                                    </textarea>
                                    @error('describe_ar')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="describe_en"
                                        class="form-control @error('describe_en') is-invalid @enderror" id="describe_en"
                                        value="" required>
                                        {{old('describe_en',$category_translation->describe_en)}}
                                    </textarea>
                                    @error('describe_en')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
